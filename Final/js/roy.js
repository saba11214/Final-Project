...
function init() {
  ...
  loader.load('images/seat.json', function(geometry1) {
    ...
    mesh1.position.x = -4000;
    mesh1.position.z = 7000;
    scene.add(mesh1);});
    ...
    loader.load('images/square.json', function(geometry2) {
      ...
      model.position.y = -6400;
      model.position.x = -4200;
      model.position.z = 4000;
      scene.add(model);});
        ...
        loader.load('images/lamp.json', function(geometry4) {
          ...
          loader.load('images/stand.json', function(geometry5) {
            ...
            loader.load('images/table.json', function(geometry6) {
              ...
              model6.position.x = 1700;
              model6.position.z = 2900;
              ...
              loader.load('images/sticks.json', function(geometry7) {
                ...
                model7.position.x = 1900;
                model7.position.z = 2800;
                ...
                model8.position.x = 1600;
                model8.position.z = 4000;
                ...
                loader.load('images/tv.json', function(geometry9) {
                  ...
                  model9.rotation.y += -0.5;
                  model9.position.x = -2700;
                  model9.position.z = 2000;
